...
async def get_characters():
    ...
    try:
        return character_manager.get_characters()
...
async def get_character_state(character_id: int = Path(..., ge=1)):
    ...
    try:
        return character_manager.get_character_state(character_id)
...
async def get_character_traits(character_id: int = Path(..., ge=1)):
    ...
    try:
        return character_manager.get_personality_traits(character_id)
    except Exception as e:
...
async def get_trait_history(
    ...
    try:
        return character_manager.get_trait_history(character_id, trait_name)
    except Exception as e:
