...
class AleziaBaseException(Exception):
    ...
    def __init__(self, message="Une erreur est survenue", status_code=500, details=None):
...
class DatabaseException(AleziaBaseException):
    ...
    def __init__(self, message="Erreur de base de données", operation=None, details=None):
        super().__init__(
            message,
            status_code=500,
            details={
