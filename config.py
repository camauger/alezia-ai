...
# Configuration CORS
CORS_ORIGINS = config(
    'CORS_ORIGINS', default='http://localhost:8080,http://127.0.0.1:8080', cast=Csv()
)
...
DB_CONFIG = {'db_path': DB_PATH, 'echo': config('DB_ECHO', default=False, cast=bool)}
...
MEMORY_CONFIG = {
    ...
    'check_semantic_similarity': config(
        'CHECK_SEMANTIC_SIMILARITY', default=True, cast=bool
    ),
}
